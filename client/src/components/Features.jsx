...
import { FiZap, FiCloud, FiGlobe, FiCpu } from 'react-icons/fi';
...
const Features = () => {
  ...
  return (
    <section className="py-24 bg-dark-primary relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(156,163,175,0.05),transparent_50%)]"></div>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_50%,rgba(229,231,235,0.05),transparent_50%)]"></div>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative bg-dark-secondary/50 backdrop-blur-sm border border-white/10 group-hover:border-cyan-500/30 rounded-2xl p-8 h-full transition-all duration-300">
                <div className={`w-16 h-16 bg-gradient-to-br ${feature.gradient} rounded-xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                  {feature.icon}
                </div>
