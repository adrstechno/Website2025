  ...
  const benefits = [
    {
      ...
      description: 'Work in a collaborative space that encourages innovation and creativity',
    },
    {
      icon: '📈',
    ...
    <div className="section-bg pt-20">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            <h1 className="text-5xl lg:text-7xl font-bold mb-6 text-primary">
              Join Our <span className="text-purple-600 dark:text-purple-400">Team</span>
            </h1>
      ...
      <section className="py-16 section-bg-alt">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-secondary">Benefits and perks of joining ADRS Techno</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((benefit, index) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="card-bg p-6 rounded-xl"
              >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold mb-6 text-primary">
              Current <span className="text-purple-600 dark:text-purple-400">Openings</span>
            </h2>
          ...
          <div className="space-y-6">
            {openings.map((job, index) => (
              <motion.div
                ...
                className="card-bg p-8 rounded-xl hover:border-purple-500/30 transition-all"
              >
      ...
      <section className="py-32 section-bg-alt">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold mb-4 text-primary">
              Application <span className="text-purple-600 dark:text-purple-400">Process</span>
            </h2>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              { step: '2', title: 'Initial Screening', description: 'Our team reviews your application' },
              ...
              >
                <div className="w-16 h-16 bg-purple-100 dark:bg-purple-500/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl font-bold text-purple-600 dark:text-purple-400">{process.step}</span>
                </div>
