    ...
    <div className="min-h-screen bg-black flex items-center justify-center py-10 px-4">
      <div className="w-full max-w-3xl">
        ...
        >
          {!success ? (
            <>
              <h1 className="text-2xl sm:text-3xl font-semibold text-white mb-6 sm:mb-8 text-center">
                Application Form
              </h1>
              ...
              <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <div className="col-span-1 sm:col-span-2 flex flex-col sm:flex-row justify-end gap-3 mt-4">
                  <button
                    type="button"
                    onClick={() => navigate(-1)}
                    className="px-5 py-2 rounded-xl bg-white/5 border border-white/10 text-white
                  ...
                  <button
                    ...
                    className="px-6 py-2 rounded-xl bg-purple-600 text-white hover:bg-purple-700 
                               disabled:opacity-50 transition text-sm sm:text-base"
                  >
                    {sending ? "Submitting..." : "Submit"}
                  </button>
                </div>
            ...
            <div className="text-center py-20 text-white">
              <h2 className="text-3xl font-semibold mb-3">Application Submitted 🎉</h2>
              <p className="text-gray-300 mb-6">Thank you! We have received your details.</p>
